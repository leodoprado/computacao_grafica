...
CScene4::CScene4()
{
	...
	pTextures->CreateTextureMipMap(0, "../Scene4/grass.bmp");
	pTextures->CreateTextureMipMap(1, "../Scene4/CasaTex.jpg");
}
...
int CScene4::DrawGLScene(void)	// Função que desenha a cena
{
	...
	glPushMatrix();
	glTranslatef(0.0f, HEIGHT - 100, 0.0f);
...
void CScene4::DrawFloor(float eixoX, float eixoY)
{
	// Aplica textura
...
void CScene4::DrawHouse() // Função para desenha a casa
{
	...
	for (int i = 0; i < 69; i++)
	{
		...
		int t1 = vCasaIndexes[i].p1;
		int t2 = vCasaIndexes[i].p2;
		int t3 = vCasaIndexes[i].p3;

		glTexCoord2f(vTexturaVertices[t1].x, vTexturaVertices[t1].y);
		glVertex3f(vCasaVertices[p1].x, vCasaVertices[p1].y, vCasaVertices[p1].z);

		glTexCoord2f(vTexturaVertices[t2].x, vTexturaVertices[t2].y);
		glVertex3f(vCasaVertices[p2].x, vCasaVertices[p2].y, vCasaVertices[p2].z);

		glTexCoord2f(vTexturaVertices[t3].x, vTexturaVertices[t3].y);
